...
const getRequestName = (request: EsQueryRequest, index: number) =>
  ...
  i18n.translate('visTypeNiitChart.esQueryParser.unnamedRequest', {
...
export class EsQueryParser {
  ...
  parseUrl(dataObject: Data, url: UrlObject) {
    ...
    if (body === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeNiitChart.esQueryParser.urlBodyValueTypeErrorMessage', {
    ...
    if (legacyContext !== undefined) {
      if (body.query !== undefined) {
        throw new Error(
          i18n.translate(
            'visTypeNiitChart.esQueryParser.dataUrlMustNotHaveLegacyAndBodyQueryValuesAtTheSameTimeErrorMessage',
            {
              defaultMessage:
        ...
        throw new Error(
          i18n.translate(
            'visTypeNiitChart.esQueryParser.dataUrlMustNotHaveLegacyContextTogetherWithContextOrTimefieldErrorMessage',
            {
              defaultMessage:
        ...
        throw new Error(
          i18n.translate('visTypeNiitChart.esQueryParser.legacyContextCanBeTrueErrorMessage', {
            defaultMessage:
      ...
      this._onWarning(
        i18n.translate('visTypeNiitChart.esQueryParser.legacyUrlShouldChangeToWarningMessage', {
    ...
    if (body.query !== undefined) {
      if (usesContext) {
        throw new Error(
          i18n.translate(
            'visTypeNiitChart.esQueryParser.urlContextAndUrlTimefieldMustNotBeUsedErrorMessage',
            {
              defaultMessage:
        ...
        for (const prop of Object.keys(obj)) {
          ...
          if (prop === 'interval' && subObj[AUTOINTERVAL]) {
            ...
            if (size === true) {
              ...
              throw new Error(
                i18n.translate('visTypeNiitChart.esQueryParser.autointervalValueTypeErrorMessage', {
          ...
          switch (subObj[TIMEFILTER]) {
            ...
            default:
              throw new Error(
                i18n.translate('visTypeNiitChart.esQueryParser.timefilterValueErrorMessage', {
                  defaultMessage:
  ...
  _getTimeBound(opts: Opts, type: Type): number {
    ...
    if (opts.shift) {
      ...
      if (typeof shift !== 'number') {
        throw new Error(
          i18n.translate('visTypeNiitChart.esQueryParser.shiftMustValueTypeErrorMessage', {
      ...
      switch (opts.unit || 'd') {
        ...
        default:
          throw new Error(
            i18n.translate('visTypeNiitChart.esQueryParser.unknownUnitValueErrorMessage', {
