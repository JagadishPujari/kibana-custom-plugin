...
import { logger, Warn, None, version as niit_chartVersion } from 'vega';
import { compile, TopLevelSpec, version as niit_chartLiteVersion } from 'vega-lite';
...
import {ChartSpec, ChartConfig} from './types'
import {
  Bool,
  Data,
  TooltipConfig,
...
export class NiitChartParser {
  ...
  async _parseAsync() {
    ...
    if (typeof this.spec === 'string') {
      ...
      if (!spec.$schema) {
        throw new Error(
          i18n.translate('visTypeNiitChart.niit_chartParser.inputSpecDoesNotSpecifySchemaErrorMessage', {
...
The URL is an identifier only. Kibana and your browser will never access this URL.`,
            values: {
              ...
              niit_chartSchemaUrl:
                'https://niit_chart.github.io/niit_chart/docs/specification/#top-level-specification-properties',
            },
          })
        );
      }
    ...
    if (!_.isPlainObject(this.spec)) {
      throw new Error(
        i18n.translate('visTypeNiitChart.niit_chartParser.invalidChartSpecErrorMessage', {
  ...
  private _compileWithAutosize() {
    ...
    if (!autosize && typeof autosize !== 'undefined') {
      this._onWarning(
        i18n.translate('visTypeNiitChart.niit_chartParser.autoSizeDoesNotAllowFalse', {
          defaultMessage:
    ...
    if (
      ...
      this._onWarning(
        i18n.translate('visTypeNiitChart.niit_chartParser.widthAndHeightParamsAreIgnored', {
          defaultMessage:
  ...
  private _compileVegaLite() {
    if (!this.useMap) {
      ...
      // Vega-Lite allows autosize when there is a single mark or layered niit_chart, but
      ...
      if ('mark' in normalized || 'layer' in normalized) {
        ...
        if (
          ...
          this._onWarning(
            i18n.translate('visTypeNiitChart.niit_chartParser.widthAndHeightParamsAreRequired', {
              defaultMessage:
                'Nothing is rendered when {autoSizeParam} is set to {noneParam} while using faceted or repeated {niit_chartLiteParam} specs. To fix, remove {autoSizeParam} or use {niit_chartParam}.',
              values: {
                autoSizeParam: '"autosize"',
                noneParam: '"none"',
    ...
    const niit_chartLogger = logger(Warn); // note: eslint has a false positive here
    niit_chartLogger.warn = this._onWarning.bind(this);
    this.spec = compile(this.vlspec as TopLevelSpec, { logger: niit_chartLogger }).spec;
    ...
    if (this.useMap) {
      ...
      if (this.vlspec.config === undefined || (hasConfig && !this.vlspec.config.projection)) {
        ...
        if (
          ...
          throw new Error(
            i18n.translate(
              'visTypeNiitChart.niit_chartParser.VLCompilerShouldHaveGeneratedSingleProtectionObjectErrorMessage',
              {
                defaultMessage:
  ...
  _parseControlPlacement() {
    ...
    if (this.containerDir === undefined) {
      if (this._config && this._config.controlsLocation === undefined) {
        ...
        throw new Error(
          i18n.translate('visTypeNiitChart.niit_chartParser.unrecognizedControlsLocationValueErrorMessage', {
            defaultMessage:
    ...
    if (dir !== undefined && dir !== 'horizontal' && dir !== 'vertical') {
      throw new Error(
        i18n.translate('visTypeNiitChart.niit_chartParser.unrecognizedDirValueErrorMessage', {
    ...
    if (this.spec) {
      if (this.spec._hostConfig !== undefined) {
        ...
        if (!_.isPlainObject(result)) {
          throw new Error(
            i18n.translate('visTypeNiitChart.niit_chartParser.hostConfigValueTypeErrorMessage', {
        ...
        this._onWarning(
          i18n.translate('visTypeNiitChart.niit_chartParser.hostConfigIsDeprecatedWarningMessage', {
            defaultMessage:
      ...
      if (_.isPlainObject(this.spec.config) && this.spec.config.kibana !== undefined) {
        ...
        if (!_.isPlainObject(result)) {
          throw new Error(
            i18n.translate('visTypeNiitChart.niit_chartParser.kibanaConfigValueTypeErrorMessage', {
              defaultMessage: 'If present, {configName} must be an object',
  ...
  _parseTooltips() {
    ...
    if (result.position === undefined) {
      ...
      throw new Error(
        i18n.translate(
          'visTypeNiitChart.niit_chartParser.unexpectedValueForPositionConfigurationErrorMessage',
          {
    ...
    if (result.padding === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeNiitChart.niit_chartParser.paddingConfigValueTypeErrorMessage', {
    ...
    if (result.textTruncate === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeNiitChart.niit_chartParser.textTruncateConfigValueTypeErrorMessage', {
    ...
    if (result.centerOnMark === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeNiitChart.niit_chartParser.centerOnMarkConfigValueTypeErrorMessage', {
  ...
  _parseMapConfig() {
    ...
    const validate = (name: string, isZoom: boolean) => {
      ...
      if (val !== undefined) {
        ...
        this._onWarning(
          i18n.translate('visTypeNiitChart.niit_chartParser.someKibanaConfigurationIsNoValidWarningMessage', {
    ...
    if (maxBounds !== undefined) {
      if (
        ...
        this._onWarning(
          i18n.translate('visTypeNiitChart.niit_chartParser.maxBoundsValueTypeWarningMessage', {
  ...
  _parseBool(paramName: string, dstObj: DstObj, dflt: boolean | string | number) {
    ...
    if (val === undefined) {
      ...
      this._onWarning(
        i18n.translate('visTypeNiitChart.niit_chartParser.someKibanaParamValueTypeWarningMessage', {
  ...
  private parseSchema(spec: ChartSpec) {
    ...
    const libVersion = isVegaLite ? niit_chartLiteVersion : niit_chartVersion;

    if (versionCompare(schema.version, libVersion) > 0) {
      this._onWarning(
        i18n.translate('visTypeNiitChart.niit_chartParser.notValidLibraryVersionForInputSpecWarningMessage', {
          defaultMessage:
  ...
  async _resolveDataUrls() {
    ...
    this._findObjectDataUrls(this.spec!, (obj: Data) => {
      ...
      if (parser === undefined) {
        throw new Error(
          i18n.translate('visTypeNiitChart.niit_chartParser.notSupportedUrlTypeErrorMessage', {
    ...
    if (Array.isArray(obj)) {
      ...
      if (key === 'data' && _.isPlainObject(obj.url)) {
        ...
        if (obj.values !== undefined || obj.source !== undefined) {
          throw new Error(
            i18n.translate(
              'visTypeNiitChart.niit_chartParser.dataExceedsSomeParamsUseTimesLimitErrorMessage',
              {
                defaultMessage:
