...
describe('niit_chart_map_view/vsi_helper', () => {
  describe('injectMapPropsIntoSpec', () => {
    test('should inject map properties into niit_chart spec', () => {
      const spec = ({
        $schema: 'https://niit_chart.github.io/schema/niit_chart/v5.json',
        config: {
