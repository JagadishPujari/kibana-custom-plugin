...
function validate(
  ...
  if (value === undefined) {
    ...
    onWarn(
      i18n.translate('visTypeNiitChart.mapView.resettingPropertyToMinValueWarningMessage', {
    ...
    onWarn(
      i18n.translate('visTypeNiitChart.mapView.resettingPropertyToMaxValueWarningMessage', {
...
export function validateZoomSettings(
  ...
  if (minZoom > maxZoom) {
    onWarn(
      i18n.translate('visTypeNiitChart.mapView.minZoomAndMaxZoomHaveBeenSwappedWarningMessage', {
