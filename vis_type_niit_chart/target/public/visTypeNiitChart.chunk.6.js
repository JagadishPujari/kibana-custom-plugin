(window["visTypeNiitChart_bundle_jsonpfunction"] = window["visTypeNiitChart_bundle_jsonpfunction"] || []).push([[6],{
...
/* harmony import */ var _niit_chart_view_niit_chart_base_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../niit_chart_view/niit_chart_base_view */ "./public/niit_chart_view/niit_chart_base_view.js");
...
/**
 * This class processes all NiitChart spec customizations,
...
class EmsFileParser {
  ...
  parseUrl(obj, url) {
    if (typeof url.name !== 'string') {
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_0__["i18n"].translate('visTypeNiitChart.emsFileParser.missingNameOfFileErrorMessage', {
  ...
  async populateData(requests) {
    ...
    for (const {
      ...
      if (!foundLayer) {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_0__["i18n"].translate('visTypeNiitChart.emsFileParser.emsFileNameDoesNotExistErrorMessage', {
      ...
      obj.url = Object(_niit_chart_view_niit_chart_base_view__WEBPACK_IMPORTED_MODULE_1__["bypassExternalUrlCheck"])(url);
    }
  }
...
const getRequestName = (request, index) => request.dataObject.name || _kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.unnamedRequest', {
...
class EsQueryParser {
  ...
  parseUrl(dataObject, url) {
    ...
    if (body === undefined) {
      ...
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.urlBodyValueTypeErrorMessage', {
    ...
    if (legacyContext !== undefined) {
      if (body.query !== undefined) {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.dataUrlMustNotHaveLegacyAndBodyQueryValuesAtTheSameTimeErrorMessage', {
        ...
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.dataUrlMustNotHaveLegacyContextTogetherWithContextOrTimefieldErrorMessage', {
        ...
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.legacyContextCanBeTrueErrorMessage', {
      ...
      this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.legacyUrlShouldChangeToWarningMessage', {
    ...
    if (body.query !== undefined) {
      if (usesContext) {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.urlContextAndUrlTimefieldMustNotBeUsedErrorMessage', {
        ...
        for (const prop of Object.keys(obj)) {
          ...
          if (prop === 'interval' && subObj[AUTOINTERVAL]) {
            ...
            if (size === true) {
              ...
              throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.autointervalValueTypeErrorMessage', {
          ...
          switch (subObj[TIMEFILTER]) {
            ...
            default:
              throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.timefilterValueErrorMessage', {
  ...
  _getTimeBound(opts, type) {
    ...
    if (opts.shift) {
      ...
      if (typeof shift !== 'number') {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.shiftMustValueTypeErrorMessage', {
      ...
      switch (opts.unit || 'd') {
        ...
        default:
          throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_1__["i18n"].translate('visTypeNiitChart.esQueryParser.unknownUnitValueErrorMessage', {
...
/***/ "./public/data_model/niit_chart_parser.ts":
/*!************************************************!*\
  !*** ./public/data_model/niit_chart_parser.ts ***!
  \************************************************/
/*! exports provided: NiitChartParser */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NiitChartParser", function() { return NiitChartParser; });
...
class NiitChartParser {
  ...
  async _parseAsync() {
    ...
    if (typeof this.spec === 'string') {
      ...
      if (!spec.$schema) {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.inputSpecDoesNotSpecifySchemaErrorMessage', {
          defaultMessage: `Your specification requires a {schemaParam} field with a valid URL for
Chart (see {niit_chartSchemaUrl}) or
Chart-Lite (see {niit_chartLiteSchemaUrl}).
The URL is an identifier only. Kibana and your browser will never access this URL.`,
          values: {
            schemaParam: '"$schema"',
            niit_chartLiteSchemaUrl: 'https://niit_chart.github.io/niit_chart-lite/docs/spec.html#top-level',
            niit_chartSchemaUrl: 'https://niit_chart.github.io/niit_chart/docs/specification/#top-level-specification-properties'
          }
        }));
      }
    ...
    if (!lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(this.spec)) {
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.invalidChartSpecErrorMessage', {
  ...
  _compileWithAutosize() {
    ...
    if (!autosize && typeof autosize !== 'undefined') {
      this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.autoSizeDoesNotAllowFalse', {
    ...
    if (useResize && (this.spec.width && this.spec.width !== 'container' || this.spec.height && this.spec.height !== 'container')) {
      this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.widthAndHeightParamsAreIgnored', {
  ...
  _compileVegaLite() {
    if (!this.useMap) {
      ...
      }).normalized; // Vega-Lite allows autosize when there is a single mark or layered niit_chart, but
      ...
      if ('mark' in normalized || 'layer' in normalized) {
        ...
        if (normalized.autosize && typeof normalized.autosize !== 'string' && normalized.autosize.type === 'none') {
          this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.widthAndHeightParamsAreRequired', {
            defaultMessage: 'Nothing is rendered when {autoSizeParam} is set to {noneParam} while using faceted or repeated {niit_chartLiteParam} specs. To fix, remove {autoSizeParam} or use {niit_chartParam}.',
            values: {
              autoSizeParam: '"autosize"',
              noneParam: '"none"',
              niit_chartLiteParam: 'Vega-Lite',
              niit_chartParam: 'Vega'
            }
          }));
        }
      }
    ...
    const niit_chartLogger = Object(vega__WEBPACK_IMPORTED_MODULE_7__["logger"])(vega__WEBPACK_IMPORTED_MODULE_7__["Warn"]); // note: eslint has a false positive here

    niit_chartLogger.warn = this._onWarning.bind(this);
    this.spec = Object(vega_lite__WEBPACK_IMPORTED_MODULE_8__["compile"])(this.vlspec, {
      logger: niit_chartLogger
    ...
    // This way we let leaflet-niit_chart library inject a different default projection for tile maps.
    // Also, VL injects default padding and autosize values, but neither should be set for niit_chart-leaflet.
    ...
    if (this.useMap) {
      ...
      if (this.vlspec.config === undefined || hasConfig && !this.vlspec.config.projection) {
        ...
        if (!Array.isArray(this.spec.projections) || this.spec.projections.length !== 1 || this.spec.projections[0].name !== 'projection') {
          throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.VLCompilerShouldHaveGeneratedSingleProtectionObjectErrorMessage', {
  ...
  _parseControlPlacement() {
    ...
    if (this.containerDir === undefined) {
      if (this._config && this._config.controlsLocation === undefined) {
        ...
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.unrecognizedControlsLocationValueErrorMessage', {
    ...
    if (dir !== undefined && dir !== 'horizontal' && dir !== 'vertical') {
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.unrecognizedDirValueErrorMessage', {
    ...
    if (this.spec) {
      if (this.spec._hostConfig !== undefined) {
        ...
        if (!lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(result)) {
          throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.hostConfigValueTypeErrorMessage', {
        ...
        this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.hostConfigIsDeprecatedWarningMessage', {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(this.spec.config) && this.spec.config.kibana !== undefined) {
        ...
        if (!lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(result)) {
          throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.kibanaConfigValueTypeErrorMessage', {
            defaultMessage: 'If present, {configName} must be an object',
            values: {
  ...
  _parseTooltips() {
    ...
    if (result.position === undefined) {
      ...
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.unexpectedValueForPositionConfigurationErrorMessage', {
    ...
    if (result.padding === undefined) {
      ...
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.paddingConfigValueTypeErrorMessage', {
    ...
    if (result.textTruncate === undefined) {
      ...
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.textTruncateConfigValueTypeErrorMessage', {
    ...
    if (result.centerOnMark === undefined) {
      ...
      throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.centerOnMarkConfigValueTypeErrorMessage', {
  ...
  _parseMapConfig() {
    ...
    const validate = (name, isZoom) => {
      ...
      if (val !== undefined) {
        ...
        this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.someKibanaConfigurationIsNoValidWarningMessage', {
    ...
    if (maxBounds !== undefined) {
      if (!Array.isArray(maxBounds) || maxBounds.length !== 4 || !maxBounds.every(v => typeof v === 'number' && Number.isFinite(v))) {
        this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.maxBoundsValueTypeWarningMessage', {
  ...
  _parseBool(paramName, dstObj, dflt) {
    ...
    if (val === undefined) {
      ...
      this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.someKibanaParamValueTypeWarningMessage', {
  ...
  parseSchema(spec) {
    ...
    const isVegaLite = schema.library === 'veg-lite';
    ...
    if (compare_versions__WEBPACK_IMPORTED_MODULE_2___default()(schema.version, libVersion) > 0) {
      this._onWarning(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.notValidLibraryVersionForInputSpecWarningMessage', {
  ...
  async _resolveDataUrls() {
    ...
    this._findObjectDataUrls(this.spec, obj => {
      ...
      if (parser === undefined) {
        throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.notSupportedUrlTypeErrorMessage', {
    ...
    if (Array.isArray(obj)) {
      ...
      if (key === 'data' && lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(obj.url)) {
        ...
        if (obj.values !== undefined || obj.source !== undefined) {
          throw new Error(_kbn_i18n__WEBPACK_IMPORTED_MODULE_6__["i18n"].translate('visTypeNiitChart.niit_chartParser.dataExceedsSomeParamsUseTimesLimitErrorMessage', {
  ...
  _setDefaultColors() {
    ...
    if (this.isVegaLite) {
      ...
      // https://github.com/niit_chart/niit_chart/issues/1083
...
//# sourceMappingURL=visTypeNiitChart.chunk.6.js.map