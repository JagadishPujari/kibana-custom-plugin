...
declare type AutoSize = 'pad' | 'fit' | 'fit-x' | 'fit-y' | 'none' | {
    type: string;
    contains: string;
} | {
    signal: string;
...
declare type ContextVarsObjectProps = string | {
    [CONSTANTS.AUTOINTERVAL]: number;
};
declare type ToolTipPositions = 'top' | 'right' | 'bottom' | 'left';
...
export declare type VegaSpec = Assign<Spec, {
    [index: string]: any;
    $schema: string;
    data?: Data;
    encoding?: Encoding;
...
export declare type Type = 'min' | 'max';
...
export declare type EsQueryRequest = Requests;
export declare type EmsQueryRequest = Requests & {
    obj: UrlObject;
};
...
export declare type ControlsLocation = 'row' | 'column' | 'row-reverse' | 'column-reverse';
export declare type ControlsDirection = 'horizontal' | 'vertical';
