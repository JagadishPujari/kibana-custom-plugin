...
function validate(
  ...
  if (value === undefined) {
    ...
    onWarn(
      i18n.translate('visTypeChart.mapView.resettingPropertyToMinValueWarningMessage', {
    ...
    onWarn(
      i18n.translate('visTypeChart.mapView.resettingPropertyToMaxValueWarningMessage', {
...
export function validateZoomSettings(
  ...
  if (minZoom > maxZoom) {
    onWarn(
      i18n.translate('visTypeChart.mapView.minZoomAndMaxZoomHaveBeenSwappedWarningMessage', {
