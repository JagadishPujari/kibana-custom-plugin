...
import { ChartAdapter, InspectDataSets } from '../chart_adapter';
...
const getDataGridArialabel = (view: InspectDataSets) =>
  i18n.translate('visTypeChart.inspector.dataViewer.gridAriaLabel', {
...
const dataSetAriaLabel = i18n.translate('visTypeChart.inspector.dataViewer.dataSetAriaLabel', {
  defaultMessage: 'Data set',
});

export const DataViewer = ({ chartAdapter, ...rest }: DataViewerProps) => {
