...
function ChartActionsMenu({ formatHJson, formatJson }: ChartActionsMenuProps) {
  ...
  const button = (
    <EuiButtonIcon
      ...
      aria-label={i18n.translate('visTypeChart.editor.chartEditorOptionsButtonAriaLabel', {
  ...
  const items = [
    <EuiContextMenuItem key="hjson" onClick={onHJsonCLick}>
      <FormattedMessage
        id="visTypeChart.editor.reformatAsHJSONButtonLabel"
        defaultMessage="Reformat as HJSON"
      />
    </EuiContextMenuItem>,
    <EuiContextMenuItem key="json" onClick={onJsonCLick}>
      <FormattedMessage
        id="visTypeChart.editor.reformatAsJSONButtonLabel"
