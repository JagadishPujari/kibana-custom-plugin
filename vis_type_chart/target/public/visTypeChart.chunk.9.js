(window["visTypeChart_bundle_jsonpfunction"] = window["visTypeChart_bundle_jsonpfunction"] || []).push([[9],{
    ...
    async _render(chartParser) {
      if (chartParser) {
        ...
        if (chartParser.useMap) {
          const {
            ChartMapView
          } = await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! ./chart_view/chart_map_view/view */ "./public/chart_view/chart_map_view/view.ts"));
          this.chartView = new ChartMapView(chartViewParams);
        } else {
          const {
            ChartView: ChartViewClass
          } = await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./chart_view/chart_view */ "./public/chart_view/chart_view.js"));
...
console.log(data); // export const data = {
//   labels,
//   datasets: [
//     {
//       type: 'line' as const,
...
const ChartVisComponent = ({
  ...
  const project = () => {
    switch (selectedOptions[0].label) {
      case "Bar":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Bar"], {
          options: options,
          data: data
        });

      case "Pie":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Pie"], {
          options: options,
          data: data
        });

      case "Polar":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["PolarArea"], {
          options: options,
          data: data
        });

      case "Radar":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Radar"], {
          options: options,
          data: data
        });

      case "Line":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Line"], {
          options: options,
          data: data
        });

      case "Doughnut":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Doughnut"], {
          data: data
        });

      case "Bubble":
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__["Bubble"], {
          options: options,
          data: data
        });

      default:
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])("h1", null, "No chart is selected");
    }
  }; // console.log("Im rendere here", visData)


  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(_elastic_eui__WEBPACK_IMPORTED_MODULE_2__["EuiResizeObserver"], {
    onResize: updateChartSize
  }, resizeRef => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])("div", {
    className: "",
    ref: resizeRef
  }, Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(_elastic_eui__WEBPACK_IMPORTED_MODULE_2__["EuiComboBox"], {
    ...
    onChange: onChange
  }), Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])("div", null, project())));
...
//# sourceMappingURL=visTypeChart.chunk.9.js.map