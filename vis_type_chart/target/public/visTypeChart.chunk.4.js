...
const ChartVisComponent = ({
  ...
  console.log("Im from backend", visData.searchAPI.inspectorAdapters.requests.getRequests()[0].response.json); // add logic to filter object and render
  ...
  if (filterSearchResponse.hits.hits) {
    ...
    var programs = lodash__WEBPACK_IMPORTED_MODULE_6___default.a.groupBy(filterSearchResponse.hits.hits, '_source.programName');
    ...
    lodash__WEBPACK_IMPORTED_MODULE_6___default.a.each(programs, function (val, key) {
      var pgm = [];
