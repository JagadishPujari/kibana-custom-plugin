...
const ChartVisComponent = ({
  ...
  const project = () => {
    switch (selectedOptions[0].label) {
      ...
      default:
        return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_7__["jsx"])("h1", null, "No chart is selected");
    }
